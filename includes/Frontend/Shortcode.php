        ...
        if ( WC()->cart->get_cart_contents_count() == 0 ) { ?>
            <div class="has-global-padding is-layout-constrained entry-content wp-block-post-content"><div class="woocommerce">
                <div class="woocommerce-notices-wrapper">
                    <div class="woocommerce-info"><?php esc_html_e('Checkout is not available whilst your cart is empty.', 'wcgt'); ?></div>
                    </div>
                    <p class="cart-empty woocommerce-info"><?php esc_html_e('Your cart is currently empty.', 'wcgt'); ?></p>
                    <p class="return-to-shop">
                        <a class="button wc-backward wp-element-button" href="<?php echo get_permalink( wc_get_page_id( 'shop' ) ); ?>"><?php esc_html_e('Return to shop', 'wcgt'); ?></a>
                    </p>
                </div>
            </div>
        <?php } else {
